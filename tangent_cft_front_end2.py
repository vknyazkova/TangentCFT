...
from tangent_cft_back_end2 import TangentCFTBackEnd
...
def main():
    ...
    if is_wiki:
        data_reader = WikiDataReader(dataset_file_path, read_slt=read_slt, queries_directory_path=queries_directory_path)
    else:
